...
//                    Log.e("@@date1", newDate.timeInMillis.toString() + " ")
        ...
        fun setTime(context: Context,txtView:TextView,title:String) {
            ...
            val onTimeListner =
                TimePickerDialog.OnTimeSetListener { view, hourOfDay, minute ->
                    if (view.isShown) {
                        ...
                        Log.e("@@time", hourOfDay.toString() + " " + minute.toString() + " " + calenderInstance[Calendar.AM_PM])
                        txtView.setText(hourOfDay.toString() + ":" + minute.toString())
                        txtView.setTextColor(Color.parseColor("#333333"))
                    }
                }
...
//            Picasso.with(context).load(path).placeholder(R.drawable.add_icon
//            ).into(ivImage)
        }
